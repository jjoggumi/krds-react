...
export const TextInput = ({
  ...
  const wrapperClass =
    `text-input ${Styles['text-input']} ${className || ''}  ${showSearchIco ? `${Styles['search-ico']}` : ''} ${showSearch ? Styles['hasSearch'] : Styles['noSearch']}`.trim();
  ...
  return (
    <div className={wrapperClass} style={styles}>
      <input
        ...
        className={`${stateClass} ${inputClassName || ''}`.trim()}
        disabled={disabled}

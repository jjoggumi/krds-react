  ...
  <div class="hitalk-messagebox">
    <div class="messagebox__top">
      ...
      <input
          ...
          @click="setSendMessageItem({sendType: 'RESERVATION'})"
      >
      <label for="rr2"><span>예약</span></label>
      <calendar-input v-if="sendMessageItem.sendType === 'RESERVATION'"/>
    </div>
...
export default {
  name: "batch-popup-content",
  components: {CalendarInput, UploadFile, UploadImage, UploadVideo},
  props: {
    option: Object,
    unusedFiles: {
      type: Array

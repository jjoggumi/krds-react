    ...
    <div class="record-recording__content mode2">
        <div class="record-recording__content__mode2">
            ...
            <div class="content-wrap">
                <p class="video-wrap" @click="openViewer">
                    <span class="thumb">
                        <img :src="file.fileThumbnailPath" alt="">
                        <button></button>
                    </span>
                </p>    
            </div>
...
export default {
    ...
    computed: {
        ...
        title: function() {
            return `${this.$moment(this.record.recordTimestamp).format('M월 D일')} 동영상`
        },
        file: function() {
            return this.record.files[0]
        },

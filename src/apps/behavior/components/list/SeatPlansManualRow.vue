                    ...
                    >
                        ...
                        >
                          <template v-if="!isHidden">
                            ...
                            <div
                              v-if="seat.student && showProfileImage"
                              class="profile"
...
export default {
    ...
    methods: {
      ...
      viewSizing() {
        const std = 0  // 한 모둠의 학생수
        const group = 0  // 모둠 갯수
        const maxGroup = (std === 4 && group >= 10) || (std === 6 && group >= 7);        
        ...
        if (maxGroup) {
            behaviorSeatingPlanEl.classList.add('group-max');
            zoom = width / conWidth;
        } else {
